...
/**
 * A fixture for testing the {@link VersionProxy} class to ensure it can successfully read all supported versions of the
 * proxy's serialized form.
 */
public final class VersionProxyAsVersionedProxyTest extends AbstractVersionedProxyTestCase {
  @Override
  protected List<SupportedVersion> getSupportedVersions() {
    return Arrays.asList(v1());
  }

  private static SupportedVersion v1() {
