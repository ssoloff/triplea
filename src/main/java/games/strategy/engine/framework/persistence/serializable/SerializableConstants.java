...
/**
 * A collection of constants for the Java object serialization layer for game data mementos.
 */
final class SerializableConstants {
  ...
  static final String MIME_TYPE = "application/x.triplea.game-data-memento+serializable";
